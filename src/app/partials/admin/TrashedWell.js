...
class TrashedWell extends Component {
  ...
  handleSubmit() {
    ...
    switch (action) {
      case 'DELETE':
        ...
        Services.delete(hairpiq).then(function(result) {
  ...
  loadItems(page) {
    ...
    Services.getTrashedList(params).then(function(result) {
